...
#define NFAWS_VIEW_SIGNUP                      @"NFAWS_VIEW_SIGNUP"
#define NFAWS_VIEW_FORGOTPASSWORD              @"NFAWS_VIEW_FORGOTPASSWORD"
#define NFAWS_VIEW_SIGNUPCONFIRMATION          @"NFAWS_VIEW_SIGNUPCONFIRMATION"
#define NFAWS_VIEW_NEWPASSWORDREQUIRED         @"NFAWS_VIEW_NEWPASSWORDREQUIRED"
#define NFAWS_VIEW_NEWPASSWORD                 @"NFAWS_VIEW_NEWPASSWORD"
#define NFAWS_VIEW_MFA                         @"NFAWS_VIEW_MFA"
#define NFAWS_VIEW_SIGNIN                      @"NFAWS_VIEW_SIGNIN"
