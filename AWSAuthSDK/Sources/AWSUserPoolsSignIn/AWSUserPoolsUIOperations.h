...
#define NFAWS_RESEND_INPROGRESS_NOTIFICATION   @"NFAWS_RESEND_INPROGRESS_NOTIFICATION"
#define NFAWS_RESEND_ERROR_NOTIFICATION        @"NFAWS_RESEND_ERROR_NOTIFICATION"
#define NFAWS_RESEND_SUCCESS_NOTIFICATION      @"NFAWS_RESEND_SUCCESS_NOTIFICATION"
